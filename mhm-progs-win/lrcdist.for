...
c
c Copyright (c) James G. MacKinnon, 1998; revised 2010-7-19
...
c
      ...
      write(6,*) ' '
c
      open (unit=13,file='lrcdist.out',access='APPEND')
  750 continue
      nxg = 0
c
...
c
      open (unit=12,file='C:\URCDIST\probs.tab',
     &  status='OLD',err=602)
  601 continue
